...
\begin{proof}
	\have[m]{a}{\script{A}}
	\have[\ ]{c}{\exists \script{x}\script{A}\substitutesome{c^\ast}{x}} \Ei{a}
\end{proof}

$^\ast$ \script{x} may replace some or all occurrences of \script{c} in \script{A}.
...
\begin{proof}
	...
	\open	
		\hypo[n]{b}{\script{A}\substitute{x}{c^\ast}}
		\have[p]{c}{\script{B}}
	\close
...
\begin{proof}
	\have[m]{a}{\script{A}}
	\have[\ ]{c}{\forall \script{x}\script{A}\substitute{c}{x}} \Ai{a}
\end{proof}
...
\begin{proof}
	...
	\have[n]{a}{\script{A}}
	\have[\ ]{ea1}{\script{A}\substitutesome{c}{d}} \by{=E}{e,a}
	\have[\ ]{ea2}{\script{A}\substitutesome{d}{c}} \by{=E}{e,a}
\end{proof}
